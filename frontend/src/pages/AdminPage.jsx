...
const AdminPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#212121] text-white p-8">
      <Link
        to="/"
        className="bg-green-500 text-white py-2 px-4 font-bold rounded-full"
      >
        Go to Home Page
      </Link>
      ...
      <form onSubmit={addAlbumHandler} className="bg-[#181818] p-6 rounded-lg shadow-lg ">
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium  mb-1">Desciption</label>
          <input
            type="text"
          ...
          {songs &&
            songs.map((e, i) => (
              <div key={i} className="bg-[#181818] p-4 rounded-lg shadow-md">
                ...
                <button onClick={()=>deleteSongHandler(e._id)} className="px-3 py-1 bg-red-500 text-white rounded">
                  <MdDelete />
                </button>
              </div>
            ))}
