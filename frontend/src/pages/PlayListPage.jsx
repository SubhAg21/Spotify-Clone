  ...
  return <Layout>
    <div className="mt-10 flex gap-8 flex-col md:flex-row md:items-center">
      {myPlaylist && myPlaylist[0] ? (
          ...
          <img src="https://picsum.photos/250" className="w-48 rounded" alt="" />
        )}
    ...
    <div className="grid grid-cols-3 sm:grid-cols-4 mt-10 mb-4 pl-2 text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer" key={i}>
      <p className="text-white">
        ...
        <img src={e.thumbnail.url} className="inline-block w-10 mr-5" alt="" />
        {e.title && e.title.slice(0,7)}...
      </p>
      <p className="text-[15px]">{e.singer}</p>
      <p className="text-[15px] hidden sm:block">{e.description && e.description.slice(0,30)}...</p>
